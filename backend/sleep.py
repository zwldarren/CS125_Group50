...
def generate_sleep_advice(sleep_score, enough_info, sleep_start_time_variance, nap_how_times, sleep_duration):
    actions = {
        "no enough data": "Less than 5 days of sleep user information. Consider wearing a sleep tracking device or manually entering sleep data to provide more insight into your sleep patterns.",
